<?php
	...
	*/
    ...
    define( 'QLIK_SENSE_PLUGIN_VERSION', '1.1.2' );
    ...
    add_action( 'wp_enqueue_scripts', 'qlik_sense_enqueued_assets', 0 );
    function qlik_sense_enqueued_assets() {
		...
		if( ! wp_script_is( 'qlik-sense-require', 'enqueued' ) ) {
			wp_enqueue_script( 'qlik-sense-require', 'https://' . esc_attr( get_option('qs_host') ) . esc_attr( get_option('qs_prefix') ) . 'resources/assets/external/requirejs/require.js', array(), QLIK_SENSE_PLUGIN_VERSION );
		}

		// Register the script
		wp_register_script( 'qlik-sense-js', QLIK_SENSE_PLUGIN_PLUGIN_DIR . 'index.js', array('jquery'), QLIK_SENSE_PLUGIN_VERSION );
