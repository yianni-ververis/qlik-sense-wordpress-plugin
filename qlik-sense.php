<?php
	...
	*/
    ...
    define( 'QLIK_SENSE_PLUGIN_VERSION', '1.0.4' );
...
<?php
	...
	function sense_object_clear_selections_func( $atts ) {
		return "<button id=\"qlik-sense-clear-selections\">{$atts['title']}</button>";
	}
	add_shortcode( 'sense-object-clear-selections', 'sense_object_clear_selections_func' );
?>